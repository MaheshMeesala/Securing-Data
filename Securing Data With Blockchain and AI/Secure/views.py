...
def PatientLogin(request):
	if request.method == 'POST':
		...
		con = pymysql.connect(host='127.0.0.1',port = 3307,user = 'root', password = 'root', database = 'SecuringData',charset='utf8')
		with con:
			cur = con.cursor()
...
def updateRevenue(value):
	db_connection = pymysql.connect(host='127.0.0.1',port = 3307,user = 'root', password = 'root', database = 'SecuringData',charset='utf8')
...
def CreateProfileData(request):
	if request.method == 'POST':
		...
		print('---------------------')
		print(hash)
		db_connection1 = pymysql.connect(host='127.0.0.1',port = 3307,user = 'root', password = 'root', database = 'SecuringData',charset='utf8')
